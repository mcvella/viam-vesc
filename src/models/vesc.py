...
class Vesc(Motor, EasyResource):
    ...
    COMM_BM_SET_BATT_TEMP_SENSOR_TEMP_RESISTANCE = 0xA5
    COMM_BM_GET_BATT_TEMP_SENSOR_TEMP_RESISTANCE = 0xA6
    COMM_BM_SET_BATT_TEMP_SENSOR_TEMP_CURRENT = 0xA7
    COMM_BM_GET_BATT_TEMP_SENSOR_TEMP_CURRENT = 0xA8
    COMM_BM_SET_BATT_TEMP_SENSOR_TEMP_VOLTAGE = 0xA9
    COMM_BM_GET_BATT_TEMP_SENSOR_TEMP_VOLTAGE = 0xAA
    COMM_BM_SET_BATT_TEMP_SENSOR_TEMP_TEMP = 0xAB
    COMM_BM_GET_BATT_TEMP_SENSOR_TEMP_TEMP = 0xAC
    COMM_BM_SET_BATT_TEMP_SENSOR_TEMP_TEMP_OFFSET = 0xAD
    COMM_BM_GET_BATT_TEMP_SENSOR_TEMP_TEMP_OFFSET = 0xAE
    COMM_BM_SET_BATT_TEMP_SENSOR_TEMP_TEMP_GAIN = 0xAF
    COMM_BM_GET_BATT_TEMP_SENSOR_TEMP_TEMP_GAIN = 0xB0
    COMM_BM_SET_BATT_TEMP_SENSOR_TEMP_TEMP_TEMP_RESISTANCE = 0xB1
    COMM_BM_GET_BATT_TEMP_SENSOR_TEMP_TEMP_TEMP_RESISTANCE = 0xB2
    COMM_BM_SET_BATT_TEMP_SENSOR_TEMP_TEMP_TEMP_TEMP_CURRENT = 0xB3
    COMM_BM_GET_BATT_TEMP_SENSOR_TEMP_TEMP_TEMP_TEMP_CURRENT = 0xB4
    COMM_BM_SET_BATT_TEMP_SENSOR_TEMP_TEMP_TEMP_TEMP_TEMP_VOLTAGE = 0xB5
    COMM_BM_GET_BATT_TEMP_SENSOR_TEMP_TEMP_TEMP_TEMP_TEMP_VOLTAGE = 0xB6
    COMM_BM_SET_BATT_TEMP_SENSOR_TEMP_TEMP_TEMP_TEMP_TEMP = 0xB7
    COMM_BM_GET_BATT_TEMP_SENSOR_TEMP_TEMP_TEMP_TEMP = 0xB8
    COMM_BM_SET_BATT_TEMP_SENSOR_TEMP_TEMP_TEMP_TEMP_TEMP_OFFSET = 0xB9
    COMM_BM_GET_BATT_TEMP_SENSOR_TEMP_TEMP_TEMP_TEMP_TEMP_OFFSET = 0xBA
    COMM_BM_SET_BATT_TEMP_SENSOR_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_GAIN = 0xBB
    COMM_BM_GET_BATT_TEMP_SENSOR_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_GAIN = 0xBC
    COMM_BM_SET_BATT_TEMP_SENSOR_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_RESISTANCE = 0xBD
    COMM_BM_GET_BATT_TEMP_SENSOR_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_RESISTANCE = 0xBE
    COMM_BM_SET_BATT_TEMP_SENSOR_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_CURRENT = 0xBF
    COMM_BM_GET_BATT_TEMP_SENSOR_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_CURRENT = 0xC0
    ...
    COMM_BM_SET_BATT_TEMP_SENSOR_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_CURRENT = 0xCB
    COMM_BM_GET_BATT_TEMP_SENSOR_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_CURRENT = 0xCC
    COMM_BM_SET_BATT_TEMP_SENSOR_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_VOLTAGE = 0xCD
    COMM_BM_GET_BATT_TEMP_SENSOR_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_VOLTAGE = 0xCE
    ...
    COMM_BM_SET_BATT_TEMP_SENSOR_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP = 0xDB
    COMM_BM_GET_BATT_TEMP_SENSOR_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP = 0xDC
    ...
    COMM_BM_SET_BATT_TEMP_SENSOR_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_RESISTANCE = 0xDF
    COMM_BM_GET_BATT_TEMP_SENSOR_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_RESISTANCE = 0xE0
    COMM_BM_SET_BATT_TEMP_SENSOR_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_CURRENT = 0xE1
    COMM_BM_GET_BATT_TEMP_SENSOR_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_CURRENT = 0xE2
    COMM_BM_SET_BATT_TEMP_SENSOR_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_VOLTAGE = 0xE3
    COMM_BM_GET_BATT_TEMP_SENSOR_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_VOLTAGE = 0xE4
    ...
    COMM_BM_GET_BATT_TEMP_SENSOR_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP = 0xE6
    ...
    COMM_BM_SET_BATT_TEMP_SENSOR_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP = 0xDB
    COMM_BM_GET_BATT_TEMP_SENSOR_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP = 0xDC
    ...
    COMM_BM_GET_BATT_TEMP_SENSOR_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_OFFSET = 0xEA
    COMM_BM_SET_BATT_TEMP_SENSOR_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_GAIN = 0xEB
    COMM_BM_GET_BATT_TEMP_SENSOR_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_GAIN = 0xEC
    COMM_BM_SET_BATT_TEMP_SENSOR_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_RESISTANCE = 0xED
    ...
    COMM_BM_SET_BATT_TEMP_SENSOR_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP = 0xF3
    COMM_BM_GET_BATT_TEMP_SENSOR_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP = 0xF4
    COMM_BM_SET_BATT_TEMP_SENSOR_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_OFFSET = 0xF5
    ...
    COMM_BM_GET_BATT_TEMP_SENSOR_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_CURRENT = 0xFC
    ...
    COMM_BM_SET_BATT_TEMP_SENSOR_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP = 0xFF
    COMM_BM_GET_BATT_TEMP_SENSOR_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP_TEMP = 0x100
    ...
    def reconfigure(
        ...
        # Get configuration from config with better defaults
        self.port = config.attributes.fields.get("port", {}).string_value or "/dev/ttyACM0"
        self.baudrate = config.attributes.fields.get("baudrate", {}).number_value or 115200
        self.timeout = config.attributes.fields.get("timeout", {}).number_value or 1.0
